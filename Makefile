...
kvaser_can_interface.comp:	$(BUILDDIR)kvaser_can_interface.o
									$(CC) $(LDFLAGS) $(LD_LIBRARY_PATH) -shared -o $(BUILDDIR)$@ $^ $(LDLIBS)
$(BUILDDIR)kvaser_can_interface.o:	$(CURRENT_DIR)/components/kvaser.can.interface/kvaser.can.interface.cc
									$(CC) $(CXXFLAGS) $(INCLUDE_DIR) -c $^ -o $@


all : flame

component : flame kvaser_can_interface.comp
